...
for i in range(1):
	...
	psspy.strt_2([0,0],r"""C:\Users\psse\Desktop\Phylicia\Transmission V Distribution Study\Poland\Channels\Centrality\poland_45_time_%d.out""" %i)
	...
	psspy.change_channel_out_file(r"""C:\Users\psse\Desktop\Phylicia\Transmission V Distribution Study\Poland\Channels\Centrality\poland_45_time_%d.out""" %i)
	psspy.run(0, 17.0,1,1,0)
	psspy.delete_all_plot_channels()
	
	#Gather the data
	chnfobj = dyntools.CHNF('C:\Users\psse\Desktop\Phylicia\Transmission V Distribution Study\Poland\Channels\Centrality\poland_45_time_%d.out' %i)
	...
	filename = "Test_45_time_%d.csv" % i #there will be an excel file for every load bus change
