...
psspy.strt_2([0,0],r"""C:\Users\psse\Desktop\Phylicia\Transmission V Distribution Study\Poland\Channels\ZIP\poland_test.out""" )
psspy.run(0, 1.0,1,1,0)
psspy.machine_chng_2(45,r"""1""",[0,_i,_i,_i,_i,_i],[_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f,_f])
psspy.change_channel_out_file(r"""C:\Users\psse\Desktop\Phylicia\Transmission V Distribution Study\Poland\Channels\ZIP\poland_test.out""" )
...
filename = "Test_1.csv"  #there will be an excel file for every load bus change
